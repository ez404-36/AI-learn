...
> На практике: именно по принципу Skills устроены навыки в этой среде (см. файлы `SKILL.md` в каталоге `.agents/skills/`). Когда задача совпадает с `description` навыка, агент подгружает его тело и следует инструкциям — ровно второй уровень progressive disclosure.
