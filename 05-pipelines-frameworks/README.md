...
|--------|----------------------|
| **Пайплайн** | Последовательность шагов, где выход одного — вход следующего |
| **LLM-пайплайн** | Пайплайн, где шаги включают вызовы LLM |
| **Chain (цепочка)** | Линейная последовательность LLM-шагов |
| **LangChain** | Фреймворк с готовыми компонентами для LLM-приложений |
| **LangGraph** | Библиотека для агентов и процессов в виде графа (с ветвлениями и циклами) |
| **Узел / ребро / состояние** | Элементы графа в LangGraph |
| **LlamaIndex** | Фреймворк, заточенный под RAG и работу с данными |
| **PyTorch** | Библиотека для создания и обучения нейросетей |
| **Тензор** | Многомерный массив чисел — единица данных в Deep Learning |
| **Autograd** | Автоматическое вычисление градиентов для backpropagation |
