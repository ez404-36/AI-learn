...
В [разделе 01](../01-foundations/README.md#5-inference-использование-обученной-модели) мы ввели **инференс** — использование уже обученной модели для генерации ответа. В [разделе 06](../06-model-adaptation/README.md) научились делать модель легче. Теперь разберём вторую половину вопроса: как заставить её отвечать **быстро** и обслуживать **много** пользователей.
