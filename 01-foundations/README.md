...
|--------|----------------------|
| **AI** | Любая попытка сделать компьютер «умным» |
| **ML** | Подход, где компьютер выводит правила из примеров, а не получает их от человека |
| **Deep Learning** | ML на основе глубоких (многослойных) нейросетей |
| **Модель** | Функция с обучаемыми параметрами |
| **Параметры / веса** | Числа внутри модели, которые подбираются при обучении |
| **Нейросеть** | Гибкая функция из множества нейронов, организованных в слои |
| **Нейрон** | Простой вычислительный элемент: взвешенная сумма + активация |
| **Слой** | Группа нейронов; сети состоят из последовательности слоёв |
| **Функция активации** | Нелинейность, дающая сети способность учить сложные зависимости |
| **Training** | Процесс подбора весов на данных |
| **Loss** | Мера ошибки модели |
| **Backpropagation** | Алгоритм вычисления, как подправить веса |
| **Inference** | Использование обученной модели для предсказания |
| **Overfitting** | Модель «зазубрила» данные и плохо обобщает |
