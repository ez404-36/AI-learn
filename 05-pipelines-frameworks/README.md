...
- **Автоматическое дифференцирование (autograd)** — сам вычисляет градиенты для backpropagation (вспомните цикл обучения из [раздела 01](../01-foundations/README.md#5-что-значит-обучить-модель)).
...
- **12–14 уверенных ответов** (включая итоговый №14) → отлично, базовый стек усвоен. Дальше — продвинутые темы: адаптация моделей, инференс и безопасность.
...
**Практика:** [упражнения к разделу 05 →](../exercises/05-pipelines-frameworks/README.md)

**Назад:** [← 04. RAG](../04-rag/README.md) &nbsp;|&nbsp; **Дальше:** [06. Адаптация и сжатие моделей →](../06-model-adaptation/README.md)

> Базовый стек собран: от нейрона до production-фреймворков. Дальше — продвинутый блок: как адаптировать и ужимать модели (06), ускорять инференс (07) и делать систему безопасной (08).
