...
- **Пробуйте руками:** к разделам 01–08 есть **практические занятия на Python** в [`exercises/`](./exercises/README.md) — заготовки с `TODO` + эталонные решения. LLM-упражнения работают через локальный [LM Studio](https://lmstudio.ai/); окружение — `uv` + Python 3.13 (инструкция в [`exercises/README.md`](./exercises/README.md)).
